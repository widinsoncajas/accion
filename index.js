...
app.get('/', (req, res) => {
  res.redirect('http://localhost/inicio.php');  // Redirige a la página PHP en tu servidor Apache
});     

app.get('/GAMA_FAMILIAR/GAMA_FAMI.php', (req, res) => {
  res.redirect('http://localhost/GAMA_FAMI.php');
});

app.get('/GAMA_MEDIA/GAMA_MEDIAA.php', (req, res) => {
  res.redirect('http://localhost/GAMA_MEDIAA.php');
});
