...
app.get('/', (req, res) => {
  res.redirect('http://localhost:80/inicio.php');  // Redirige a la página PHP en tu servidor Apache
});

app.get('/GAMA_FAMILIAR/GAMA_FAMI.php', (req, res) => {
  res.redirect('http://localhost:80/GAMA_FAMI.php');
});

app.get('/GAMA_MEDIA/GAMA_MEDIAA.php', (req, res) => {
  res.redirect('http://localhost:80/GAMA_MEDIAA.php');
});
